...
class ClinicalSynthetizer:
    ...
    def generate(self):
        ...
        mean_birth_weight = self.cont_distributions['BIRTH_WEIGHT_NC']['mean']
        std_birth_weight = self.cont_distributions['BIRTH_WEIGHT_NC']['std']
        mean_gestational_age = self.cont_distributions['GEST_AGE_NC']['mean']
        std_gestational_age = self.cont_distributions['GEST_AGE_NC']['std']
        ...
        weight_birth_order = {1: 0, 2: -1000}
        gest_birth_order = {1: 0, 2: -4}
