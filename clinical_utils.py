...
def get_variables_description():
    description = {
        'BIRTH_WEIGHT_NC': 'Birth weight in grams',
        'GEST_AGE_NC': 'Gestational age in weeks',
        'MAT_AGE_NC': 'Maternal age in years',
        ...
        'BIRTH_ORDER_NC': 'Birth order of the child in the case of twins. First child is encoded as 0, second child as 1.',
...
def get_correlated_variables(variable):
    if variable == InducedVariableName.MS:
        return [InductorVariable.BW, InductorVariable.AP1, InductorVariable.GA, InductorVariable.EG,
                InductorVariable.MA, InductorVariable.MR,
                InductorVariable.BB, InductorVariable.PS]
    elif variable == InducedVariableName.BB:
        return [InductorVariable.MR, InductorVariable.EG, InductorVariable.MA]
